...
def _train(train_loader, model, gloss_dict, synset_weight_dict, optim, schedule, criterion,\
...
def train_model(args):
    ...
    synset_weight_dict = json.load(open(os.path.join(args.postprocess_data_path, 'semcor_synset_weight_{}_{}.json'.format(args.K, args.gamma))))
    ...
    for epoch in range(1, epochs+1):
        model, optimizer, schedule, train_loss = _train(train_loader, model, train_gloss_dict, synset_weight_dict, optimizer, schedule, criterion, \
